        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400">
                    Desarrollado por 
                    <span class="font-medium text-gray-900 dark:text-gray-200">Enoc Hernandez</span>
                </p>
                <p class="text-xs text-gray-500 dark:text-gray-500 mt-1">
                    © {{ currentYear }} Gestor de Gastos. Todos los derechos reservados.
                </p>
                </div>
                ...
                <a 
                    href="https://linkedin.com/in/eehcx" 
                    target="_blank"
                    class="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300 transition-colors"
                    title="LinkedIn"
                >
            ...
            <div class="mt-4 pt-4 border-t border-gray-100 dark:border-gray-800/50">
                ...
                Construido con Nuxt 3, Vue 3, TypeScript y Tailwind CSS
                </p>
            </div>
        </div>
    </footer>
